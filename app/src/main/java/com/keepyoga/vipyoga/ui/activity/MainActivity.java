...
import com.keepyoga.vipyoga.ui.fragment.YujiaListFragment;
...
import com.keepyoga.vipyoga.ui.fragment.MomentListFragment;
import com.keepyoga.vipyoga.ui.fragment.MonoListFragment;
import com.keepyoga.vipyoga.ui.fragment.NGListFragment;
import com.keepyoga.vipyoga.ui.fragment.ZcoolListFragment;
import com.keepyoga.vipyoga.ui.fragment.ZhihuListFragment;
import com.keepyoga.vipyoga.ui.gank.GankDailyActivity;
import com.keepyoga.vipyoga.ui.search.SearchActivity;
import com.keepyoga.vipyoga.utils.UIHelper;
...
public class MainActivity extends BaseCompatActivity {
    ...
    private void showAll() {
        ...
        if (mPreferencesHelper.isModuleSelected(getString(R.string.yujia))) {
            mMyTabItems.add(new MyTabItem(getString(R.string.yujia), YujiaListFragment.newInstance(), R.color.moment));
        }
    ...
    private void initDrawer() {
        ...
        mColumnSelectTextView.setOnClickListener(v -> {
            if (mColumnSelectView == null) {
                ...
                linearLayout.addView(getCheckBox(getString(R.string.yujia)));
